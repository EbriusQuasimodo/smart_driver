...
ThemeData themeData(BuildContext context){
  return ThemeData(
    useMaterial3: true,
    fontFamily: 'Inter',
    colorScheme: ColorScheme.fromSeed(seedColor: AppColors.yellow, background: AppColors.bgBlack),
    inputDecorationTheme: InputDecorationTheme(
       fillColor: AppColors.bgBlack,
        ...
        hintStyle: TextStyle(color: AppColors.darkGray, fontWeight: FontWeight.w400),
